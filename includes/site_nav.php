...
$nav_admin_salary_href = $nav_admin_salary_href ?? 'pages/admin/salary.php';
        ...
        <?php else: ?>
            <div class="site-nav-links">
                ...
                <?php if ($nav_show_admin): ?>
                    ...
                    <a href="<?php echo htmlspecialchars($nav_admin_salary_href); ?>" class="<?php echo $nav_admin_section === 'salary' ? 'nav-active' : ''; ?>">Зарплаты</a>
                    <a href="<?php echo htmlspecialchars($nav_admin_report_href ?? 'pages/admin/report_download.php'); ?>" style="font-weight:600;">↓ Отчёт</a>
                <?php endif; ?>
